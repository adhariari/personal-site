       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="?page=vwSmnr">
                <i class="fa fa-calendar"></i> <span>Manajemen Acara</span>
              </a>
            </li>

            <li class="treeview">
              <a href="?page=vwPst">
                <i class="fa fa-user-plus"></i> <span>Manajemen Peserta</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="?page=grafik-edu"><i class="fa fa-circle-o"></i> Peserta - Jurusan</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="?page=vwEdu"><i class="fa fa-circle-o"></i> Jurusan</a></li>
         ...
         <footer class="main-footer">
          ...
          <strong>Copyright &copy; 2017 <a href="media.php?page=dashboard">Event Management</a>.</strong> All rights reserved.
        </footer>
      </div><!-- ./wrapper -->
