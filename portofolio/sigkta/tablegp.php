...
<!--           <li class="menu-has-children"><a href="#">Maps</a>
  ...
  <section id="herogp">
    <div class="hero-container">
      <h1>Tabel Data</h1>
      <h2>Persebaran Gully Plug/Pengendali Jurang di Kabupaten Bandung</h2>
      <a href="#about" class="btn-get-started">View <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
    </div>
  </section><!-- #hero -->
      ...
      <div class="container">
        <div class="row about-container">
          <div class="col-lg-12 content order-lg-1 order-2">
            <h2 class="title" align="center">Data Persebaran Gully Plug/Pengendali Jurang</h2>
            <p>
...
<table id="example" class="table table-bordered table-hover" style="width:100%">
        ...
        <tbody>
                ...
                $vw = mysqli_query($connect, "SELECT * FROM gp");
                $no = 1;
                while ($r = mysqli_fetch_array($vw)){
                  ...
                  <tr>
                    ...
                    <td><?php echo "$r[kawasan]"; ?></td>
                    <td><?php echo "$r[latitude]"; ?></td>
                    <td><?php echo "$r[longitude]"; ?></td>
                    <td>
                      <div class="btn-group">
                        <a href="detail.php?map=gp&id=<?php echo $r['id_gp']; ?>" target="_blank" class="btn btn-outline-success btn-sm" role="button"><i class="fa fa-map-pin" aria-hidden="true"></i> Map</a>
                      </div>
                    </td>
                  </tr>
        ...
        <section id="facts">
          ...
          if($_GET['kata']==''){
            ...
            $kata = $_GET['kata'];
            $sql = mysqli_query($connect,"SELECT *, COUNT(gp.id_gp) as jml_gp FROM gp WHERE desa LIKE '$kata' OR kecamatan LIKE '$kata' ");
            $s = mysqli_fetch_array($sql);
            $jml_gp = $s['jml_gp'];
            $total = $jml_gp/100 * 100;
          }
          ?>
          ...
          <div class="container wow fadeIn">
            <div class="section-header">
              ...
              ?>
              <p class="section-description">Jumlah Bangunan Pengendali Jurang disuatu Lokasi</p>
            </div><center>
              <?php
              if($_GET['kata']==''){
                ...
                ?>
                <p class="section-description">Jumlah pengendali jurang di <?php echo "$kata"; ?> terdapat sebanyak <?php echo "$total%"; ?> dari total 100 bangunan pengendali jurang.<br>
              ...
              <div class="col-md-6">
                <form method="GET" action="?">
                  <div class="form-group search-box">
                    <center><small style="margin-bottom: 5px;" id="emailHelp" class="form-text text-muted">Masukkan nama kecamatan atau desa.</small></center>
