  ...
  <!--==========================
    ...
    <section id="herodpn">
      <div class="hero-container">
        <h1>Tabel Data</h1>
        <h2>Persebaran Dam Penahan di Kabupaten Bandung</h2>
      ...
      <section id="about">
        <div class="container">
          <div class="row about-container">
            <div class="col-lg-12 content order-lg-1 order-2">
              <h2 class="title" align="center">Data Persebaran Dam Penahan</h2>
              <p>
              ...
              <div class="table-responsive">
                <table id="example" class="table table-bordered table-hover" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $vw = mysqli_query($connect, "SELECT * FROM dpn");
                    $no = 1;
                    while ($r = mysqli_fetch_array($vw)){
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="detail.php?map=dpn&id=<?php echo $r['id_dpn']; ?>" target="_blank" class="btn btn-outline-success btn-sm" role="button"><i class="fa fa-map-pin" aria-hidden="true"></i> Map</a>
                          </div>
                        </td>
                      </tr>
        ...
        <section id="facts">
          ...
          if($_GET['kata']==''){
            ...
            $kata = $_GET['kata'];
            $sql = mysqli_query($connect,"SELECT *, COUNT(dpn.id_dpn) as jml_dpn FROM dpn WHERE desa LIKE '%$kata%' OR kecamatan LIKE '%$kata%' OR blok LIKE '%$kata%'");
            $s = mysqli_fetch_array($sql);
            $jml_dpn = $s['jml_dpn'];
            $total = $jml_dpn/50 * 100;
          }
          ?>
          ...
          <div class="container wow fadeIn">
            <div class="section-header">
              ...
              ?>
              <p class="section-description">Jumlah Bangunan Dam Penahan disuatu Lokasi</p>
            </div><center>
              <?php
              if($_GET['kata']==''){
                ...
                ?>
                <p class="section-description">Jumlah dam penahan di <?php echo "$kata"; ?> terdapat sebanyak <?php echo "$total%"; ?> dari total 50 bangunan dam penahan.<br>
              ...
              <div class="col-md-6">
                <form method="GET" action="?">
                  <div class="form-group search-box">
                    <center><small style="margin-bottom: 5px;" id="emailHelp" class="form-text text-muted">Masukkan nama kecamatan atau desa atau blok/lokasi.</small></center>
